...
在JDK1.7版本中，ConcurrentHashMap的数据结构是由一个Segment数组和多个HashEntry组成，如下图所示：
 ...
 ![img](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210617200211.png)
...
![img](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210617200223.png)
...
![img](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210617200243.png)
