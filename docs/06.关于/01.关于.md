...
#### 技能
* 熟悉 Java、Android、Kotlin的拼写
* 了解 Linux、Windows、macOS 的开关机方式
* 精通 Git 的 pull 和 push，并注册了 GitHub 帐号刷了一些 star

本人↓↓↓

<img src='https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/202108292200530.jpg' alt='本人照片' style="width:106px;">


## :email: 联系

- **QQ**: <a :href="qqUrl" class='qq'>2726109782</a>
- **Email**:  <a href="mailto:iqqcode@qq.com">iqqcode@qq.com</a>
- **GitHub**: <https://github.com/IQQcode>
- **Java知识点文档**：<https://iqqcodes.gitee.io/coan/#/>
- **CSDN**：<https://blog.csdn.net/weixin_43232955>
