...
![在这里插入图片描述](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203059.png)
线程池会一直开启，使用完了线程，会自动把线程归还给线程池，线程可以继续使用

![在这里插入图片描述](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203103.png)

-----------------------------

## 2. 线程池核心接口

![](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203109.png)
...
![](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203115.png)
...
![](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203122.png)

**【窗口最大营业】**

如果今天是银行还贷款日，来银行办理业务的人特别多，候客区一直处于全满的状态。此时，银行就需要做出相应的调整了，让所有的窗口全部开启，银行到达最大营业数。

![](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203127.png)
...
![在这里插入图片描述](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203140.png)

![](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203145.png)
...
![在这里插入图片描述](https://iqqcode-blog.oss-cn-beijing.aliyuncs.com/img-2021-later/20210621203157.png)
